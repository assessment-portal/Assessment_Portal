...
{
$sn++;
header("location:uaccount.php?q=quiz&step=2&eid=$eid&n=$sn&t=$total")or die('Error152');
}
...
header("location:uaccount.php?q=result&eid=$eid");
}
else
{
header("location:uaccount.php?q=result&eid=$eid");
...
$sun=$sun-$s;
$q=mysqli_query($conn,"UPDATE `rank` SET `score`=$sun ,time=NOW() WHERE email= '$email'")or die('Error174');
header("location:uaccount.php?q=quiz&step=2&eid=$eid&n=1&t=$t");
}

?>
<?php
// if(@$_GET['q']== 'subans' && @$_GET['step']== 3) {
// $eid=@$_GET['eid'];
// $sn=@$_GET['n'];
// $total=@$_GET['t'];
// $ans=$_POST['ans'];
...
//  if($sn == 1)
// {
// $q3=mysqli_query($conn,"INSERT INTO subans VALUES  ('$qid','$ansid' , '$ans')") or die('Error20');
// }
// //     header("location:dash.php?q=0");
//     if($sn != $total)
// {
// $sn++;
//         $q4=mysqli_query($conn,"INSERT INTO subans VALUES  ('$qid','$ansid' , '$ans')") or die('Error20');
// header("location:uaccount.php?q=subans&step=2&eid=$eid&n=$sn&t=$total")or die('Error152');
// }
// }
?>
