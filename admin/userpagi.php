...
$c++;
echo '<tr><td style="color:black"><b>'.$c.'</b></td><td>'.$nam.'</td><td>'.$email.'</td><td>'.$s.'</td><td>';
}
echo '</table></div></div>';}
...
//       echo $name;
   ...
   echo '<div class="topnav"><div class="search-container"><form method="post" action="search.php?q=searchsubject"><input type="text" name="subsr" placeholder="Search Subject" /><button type="submit" name="sears"><i class="fa fa-search"></i></button></form><form method="post" action="search.php?q=searchteacher"><input type="text" name="tachsr" placeholder="Search Teacher" /><button type="submit" name="searth"><i class="fa fa-search"></button></form></div></div>';
...
$num_rows = $result->num_rows;
    ...
    $page_data =mysqli_query($conn,"SELECT * FROM studregister LIMIT " .$per_page. " OFFSET " . $offset) or die('Error');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b> First Name</b></td><td><b> Last Name</b></td><td><b>Gender</b></td><td><b>Email</b></td><td><b>Subject</b></td><td><b>ContactNo.</b></td><td><b>Address</b></td><td><b>Teacher</b></td><td><b>Add Teacher</b></td><td><b>Edit</b></td><td><b>Delete</b></td><td></td></tr>';
$c=1;
...
?>
	...
	<td><a title="Delete User" href="update.php?demail='.$email.'"><b><span class="glyphicon glyphicon-trash" aria-<?phphidden="true"></span></b></a></td></tr>
